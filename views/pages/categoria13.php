...
<body>
    <div class="container mt-5">
        <h2>Categoría 13 - Capacitación M</h2>
        <br>
                        ...
                        <div id="<?php echo $collapseId; ?>" class="collapse" aria-labelledby="<?php echo $headingId; ?>" data-parent="#accordionFactors">
                            <div class="card-body">
                                <form action="../includes/guardar_respuesta.php" method="POST" class="save-form" id="form-<?php echo $index; ?>">
                                    ...
                                    <input type="hidden" name="id_categoria" value="13"> <!-- Cambia este valor según la categoría -->
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-body">
        ...
        <div class="text-center mt-4">
            <button id="continueBtn" class="btn btn-success" style="display: none;" onclick="location.href='categoria14.php';">Continuar a la siguiente página</button>
        </div>
        <div class="text-center mt-4">
