...
$pares = [  
    [12, 13], [12, 14], [12, 15], [12, 16], [12, 17], [18, 18]
];
...
<body>
    <div class="container mt-5">
                        ...
                        <div id="<?php echo $collapseId; ?>" class="collapse" aria-labelledby="<?php echo $headingId; ?>" data-parent="#accordionFactors">
                            <div class="card-body">
                                <form action="../includes/guardar_respuesta.php" method="POST" class="save-form" id="form-<?php echo $index; ?>">
                                    ...
                                    <input type="hidden" name="id_categoria" value="12"> <!-- Cambia este valor según la categoría -->
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="card-body">
        ...
        <div class="text-center mt-4">
            <button id="continueBtn" class="btn btn-success" style="display: none;" onclick="location.href='categoria13.php';">Continuar a la siguiente página</button>
        </div>
        <div class="text-center mt-4">
